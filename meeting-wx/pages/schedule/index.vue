<template>
    ...
    -->
		...
		<view class="event-list">
			<view class="event-container" @click="handleToDetail(event.id)" :key="index"
				...
				<view class="event-card">
					...
					<view class="event-details">
						...
						<MeetingTimeMetaComponent :beginTime="event.beginTime" :title="event.title"
