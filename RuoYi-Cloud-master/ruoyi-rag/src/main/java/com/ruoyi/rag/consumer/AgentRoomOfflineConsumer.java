...
@Component
public class AgentRoomOfflineConsumer implements InitializingBean {
    private static final Logger logger = LoggerFactory.getLogger(AgentRoomOfflineConsumer.class);
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        mqPushConsumer.setConsumerGroup(rocketMQConsumerProperties.getGroupName() + "_" + AgentRoomOfflineConsumer.class.getSimpleName());
        ...
        mqPushConsumer.setMessageListener((MessageListenerConcurrently) (msgs, context) -> {
            for (MessageExt msg : msgs) {
                ...
                agentRoomService.userOfflineHandler(imOfflineDTO);
            }
